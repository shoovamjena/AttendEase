package com.ironheartproduction.attendelite.notification
...
class ClassNotificationReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val wakeLock = powerManager.newWakeLock(
            ...
            "AttendElite:ClassNotificationWakeLock"
        )
                ...
                for (timetableEntry in classesForToday) {
                    try {
                        ...
                        if (classTimeParsed.isAfter(currentTimeParsed)) {
                            ...
                            val notificationTime = classTimeParsed.minusMinutes(20)
